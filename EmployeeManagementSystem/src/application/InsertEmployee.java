...
public class InsertEmployee {
	...
	public void insertData(ActionEvent e) throws IOException {
		...
		String dateOfBirth = dateberith.toString(); // j'ai utiliser la methode toString() car j'ai defini la date of
													// birth en tant que String
		...
		if (status > 0) {
			...
			// System.out.println("Record saved successfully!"); just for testing in console
			...
			// System.out.println("Sorry! unable to save Record"); just for testing in console
